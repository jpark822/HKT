...
public class SQLiteDatabase
{
    ...
    public SQLiteDatabase()
    {
        ...
        currentDirectoryInfo = currentDirectoryInfo.Parent;
        currentDirectoryInfo = currentDirectoryInfo.Parent;
        String path = currentDirectoryInfo.FullName;
        path += "\\DomainModel\\HKTSQLiteDB.s3db";
    ...
    public int GetNumberOfRowsInTable(String table)
    {
        ...
        try
        {
            ...
            connection.Open();
            SQLiteCommand mycommand = new SQLiteCommand(connection);
            mycommand.CommandText = "select COUNT(*) from " + table;
            SQLiteDataReader reader = mycommand.ExecuteReader();
            dt.Load(reader);
            reader.Close();
            connection.Close();
    ...
    public DataRow GetLastRowInTable(String table)
    {
        DataTable dt = new DataTable();
        try
        {
            ...
            connection.Open();
            SQLiteCommand command = new SQLiteCommand(connection);
            command.CommandText = "select * from " + table + " order by ticket_id desc limit 1";
            SQLiteDataReader reader = command.ExecuteReader();
            dt.Load(reader);
            reader.Close();
            connection.Close();
