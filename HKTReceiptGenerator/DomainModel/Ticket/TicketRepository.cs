...
namespace DomainModel.Ticket
{
    ...
    public class TicketRepository : BaseRepository
    {
        ...
        public TicketResource GetTicketByTicketID(int ticketId)
        {
            ...
            getTicketCommand.CommandText = "select * from Tickets join Customer on Tickets.CustomerId = Customer.id where ticket_id = @ticket_id LIMIT 1";
        ...
        public List<TicketResource> GetTicketsByArguments(Dictionary<TicketProperty, object> arguments)
        {
            ...
            String sql = "select * from Tickets join Customer on Tickets.CustomerId = Customer.id where ";
        ...
        public List<TicketResource> GetDistinctEmailAddressBetweenDates(DateTime startDate, DateTime endDate)
        {
            ...
            MySqlCommand getTicketsCommand = new MySqlCommand();
            getTicketsCommand.Connection = connector.connection;
            getTicketsCommand.CommandText = "select distinct email, first_name, last_name from Tickets join Customer on Tickets.CustomerId = Customer.id where date_in >= @startDate AND date_in <= @endDate";
        ...
        private TicketResource ConvertDataRowToTicketResource(DataRow dataRow)
        {
            ...
            int customerId = dataRow["CustomerId"] is DBNull ? 0 : Convert.ToInt32(dataRow["CustomerId"]);
            ...
            String telephone = dataRow["phone"] is DBNull ? "" : (String)dataRow["phone"] ?? "";
        ...
        private TicketResource ConvertSQLReaderRowToTicketResource(MySqlDataReader reader)
        {
            ...
            int customerId = reader["CustomerId"] is DBNull ? 0 : Convert.ToInt32(reader["CustomerId"]);
            ...
            String zip = reader["zip"] is DBNull ? "" : Convert.ToString(reader["zip"] ?? "");
            String telephone = reader["phone"] is DBNull ? "" : (String)reader["phone"] ?? "";
